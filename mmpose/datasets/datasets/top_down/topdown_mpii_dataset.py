...
class TopDownMPIIDataset(TopDownBaseDataset):
    """MPIIDataset dataset for top-down pose estimation.
    ...
    def evaluate(self, outputs, res_folder, metrics='PCKh', **kwargs):
        ...
        Adapted from https://github.com/leoxiaobin/deep-high-resolution-
        net.pytorch
        ...
        gt_file = os.path.join(self.ann_file[:-11], 'gt_valid.mat')
